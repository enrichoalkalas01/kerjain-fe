		...
		<div class="block">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						...
						<div class="job-listings-sec">
							<div class="job-listing">
								...
								<span class="job-lctn"><i class="la la-map-marker"></i>Jakarta</span>
							...
							<div class="job-listing">
								...
								<span class="job-lctn"><i class="la la-map-marker"></i>Semarang</span>
								<span class="fav-job"><i class="la la-heart-o"></i></span>
								<span class="job-is ft">FULL TIME</span>
							</div><!-- Job -->
							<div class="job-listing">
							...
							<div class="job-listing">
								...
								<span class="job-lctn"><i class="la la-map-marker"></i>Depok</span>
								<span class="fav-job"><i class="la la-heart-o"></i></span>
							...
							<div class="job-listing">
								...
								<span class="job-lctn"><i class="la la-map-marker"></i>Makassar</span>
								<span class="fav-job"><i class="la la-heart-o"></i></span>
								<span class="job-is ft">FULL TIME</span>
							</div><!-- Job -->
						</div>
					...
					<div class="col-lg-12">
						<div class="browse-all-cat">
							<a href="#" title="">Lihat semua list</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="simple-text">
							...
							<span>Kami di sini untuk membantu. Lihat FAQ kami, kirim email atau hubungi kami di 0 (62) 555-5555</span>
						</div>
					</div>
				</div>
			</div>
